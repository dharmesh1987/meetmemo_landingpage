...
const Icons = {
  googleMeet: () => (
    <Image src="/google-meet.svg" alt="Meetmemo" width={100} height={100} />
  ),
  meetmemo: () => (
    <Image
  ...
  teams: () => (
    <Image src="/teams.svg" alt="Meetmemo" width={100} height={100} />
  ),
  whatsapp: () => (
    <Image src="/whatsapp.svg" alt="Meetmemo" width={100} height={100} />
  ),
  zoom: () => <Image src="/zoom.svg" alt="Meetmemo" width={100} height={100} />,
  googleCalendar: () => (
    <Image src="/g-calendar.svg" alt="Meetmemo" width={100} height={100} />
  ),
  messenger: () => (
    <svg
      width="100"
